...
Installs the optional developer tools that the shell profile configures (oh-my-zsh, mise, node, gh, claude, cargo, platformio, opencode). Run after `./install.sh`; every tool can be skipped.
